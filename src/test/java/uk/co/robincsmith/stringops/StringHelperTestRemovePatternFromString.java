...
/**
 * Tests the removePatternFromString() method of the StringHelper class. Uses
 * parametrised testing.
 * @author Robin Smith
 */
@RunWith(Parameterized.class)
public class StringHelperTestRemovePatternFromString
{
     ...
     */
    public StringHelperTestRemovePatternFromString(String input,
                                                   String pattern,
     ...
     */
    @Test
    public void testRemovePatternFromString()
    {
        assertEquals(expectedOutput, sh.removePatternFromString(pattern, input));
    }
}
